...
Param(
    ...
    [String]$ConsumerGroupName = "psrConsumerGroup",# optional    default to "MyConsumerGroup"
...
Write-Output "Process of creating the consumer group [$ConsumerGroupName] started."
...
Write-Host "The consumer group [$ConsumerGroupName] has been successfully created."
