...
Param(
    ...
    [String]$TopicName,                                      # required    needs to be alphanumeric    
...
{
    Write-Output "The [$TopicName] topic already exists in the [$Namespace] namespace." 
}
else
{
    Write-Output "Creating the [$TopicName] topic in the [$Namespace] namespace..."
    ...
    Write-Host "The [$TopicName] topic in the [$Namespace] namespace has been successfully created."
}
